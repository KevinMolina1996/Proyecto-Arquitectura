...
<body class="py-3">
    ...
    <main class="container">
        <div class="row">
            <div class="col">
                <h4>Registro de pelicula Peliculas</h4>
            </div>
        </div>
            ...
            <div class="col">
             <form class = 'row g-3' method="POST" autocomplete='off'>
                ...
                <div class="col-md-3">
                    ...
                    <Input type="text" id="nuevo_nombre" name="nuevo_nombre" class="form-control" required autofocus>
                </div>
